...
if ($access_token) {
    try {
        ...
        if ($decoded) {
            $sql = "SELECT products.id, products.price, products.quantity, 
            products.name as nameProduct, products.images, products.content, 
            categories.name as nameCategory, products.create_at 
